...
public class WiFiServiceDiscoveryActivity extends Activity implements Handler.Callback, ConnectionInfoListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getFragmentManager().beginTransaction()
                .add(dozaengine.nanocluster.R.id.container_root, servicesList, "services").commit();
                ...
                new DnsSdServiceResponseListener() {
                    ...
                    public void onDnsSdServiceAvailable(String instanceName,
                        ...
                        if (instanceName.equalsIgnoreCase(SERVICE_INSTANCE)) {
                            ...
                            // TODO: Update to accept the Service despite fragment
                            // TODO: App Specific Code: Refactor
                            // update the UI and add the item the discovered
                            // device.
                            WiFiDirectServicesList fragment = (WiFiDirectServicesList) getFragmentManager()
                                    .findFragmentByTag("services");
                            if (fragment != null) { // TODO: Update Here
    ...
    public void onConnectionInfoAvailable(WifiP2pInfo p2pInfo) {
        ...
        if (p2pInfo.isGroupOwner) {
            ...
            try {
                ...
                handler = new GroupOwnerSocketHandler(this.handler);
                handler.start();
            } catch (IOException e) {
                Log.d(TAG,
            ...
            handler = new ClientSocketHandler(this.handler, p2pInfo.groupOwnerAddress);
            handler.start();
        }
        ...
        getFragmentManager().beginTransaction()
                .replace(dozaengine.nanocluster.R.id.container_root, chatFragment).commit();
